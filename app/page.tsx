...
import { Monitor, Laptop, Wrench, Shield, Users, Zap, Star, ArrowRight } from 'lucide-react';
  ...
  return (
    <main className="min-h-screen bg-background">
      ...
      <section className="relative overflow-hidden py-20 md:py-32 bg-gradient-to-br from-primary via-primary/5 to-background">
        ...
        <div className="absolute bottom-0 left-0 w-72 h-72 bg-primary/10 rounded-full translate-y-1/2 -translate-x-1/2"></div>
        
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-3xl mx-auto text-center">
            <div className="inline-block mb-6 px-4 py-2 bg-accent/20 rounded-full border border-accent/40">
              <span className="text-accent font-semibold text-sm">Welcome to Dan Computers</span>
            </div>
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-primary mb-6 leading-tight">
              Your Trusted Computer & CCTV Solutions
            </h1>
            <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">
              Quality computers, accessories, and professional CCTV installations. Expert repair services and dedicated customer support since day one.
            </p>
            ...
            {[
              {
                ...
                description: 'New and refurbished laptops, desktops, monitors, and accessories',
              },
              {
                icon: Wrench,
                title: 'Repair & Maintenance',
                description: 'Professional computer and printer repair with quick turnaround',
              },
              {
                icon: Shield,
                title: 'CCTV Solutions',
                description: 'Sales, installation, and maintenance of security camera systems',
              },
              {
                icon: Zap,
                title: 'Network Setup',
                description: 'Professional networking solutions and IT infrastructure setup',
              },
              {
                icon: Monitor,
              ...
              },
              {
                ...
                description: 'Dedicated customer support and technical assistance',
              },
            ].map((service, idx) => {
              ...
              return (
                <ScrollAnimate key={idx} delay={idx * 100}>
                  <div
                    className="p-6 bg-card rounded-xl border border-border hover:border-primary/50 transition-colors group h-full"
                  >
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <div key={idx} className="bg-card rounded-xl border border-border overflow-hidden hover:shadow-lg transition-shadow">
                <div className="h-40 bg-gradient-to-br from-primary/20 to-accent/20 flex items-center justify-center">
                  <Monitor className="text-primary/40" size={48} />
                </div>
                <div className="p-4">
                  <p className="text-xs text-primary font-semibold uppercase mb-1">{product.category}</p>
              ...
              {[
                {
                  ...
                  description: 'We source only genuine, high-quality computers and accessories from trusted manufacturers.',
                },
                {
                  title: 'Expert Technicians',
                  description: 'Our team has years of experience in computer repair, CCTV installation, and IT support.',
                },
                {
                  title: 'Local Expertise',
                  description: 'Based in Likoni, Mombasa - we understand local needs and provide personalized solutions.',
                },
                {
                  title: 'Competitive Pricing',
                  description: 'Best prices in the market without compromising on quality or service.',
                },
                {
                  title: 'Quick Turnaround',
                  description: 'Fast repair services and quick installation of systems and security equipment.',
                },
                {
                  title: 'Customer Support',
                  description: 'Dedicated support available via phone, WhatsApp, and in-store for your convenience.',
                },
              ].map((item, idx) => (
